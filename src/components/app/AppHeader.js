...
export class AppHeader extends LitElement {
    ...
    getViewTitle() {
        const titles = {
            onboarding: 'Welcome to Telegram - @Interview_Helper',
            main: 'Telegram - @Interview_Helper',
            customize: 'Customize',
            help: 'Help & Shortcuts',
            history: 'Conversation History',
            advanced: 'Advanced Tools',
            assistant: 'AI Interview Assistant',
        };
        return titles[this.currentView] || 'Telegram - @Interview_Helper';
    }
