            ...
            <div class="help-container">
                <div class="option-group">
                    ...
                    <div class="community-links">
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://t.me/interview_helper')}>
                            🌟 Official Channel
                        </div>
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://t.me/Coding_Exam_helpers')}>
                            ⚡ Exam Help Channel
                        </div>
                        <div class="community-link" @click=${() => this.handleExternalLinkClick('https://t.me/Rahul_2233')}>
                            💬 Contact Me
                        </div>
                    </div>
                </div>
                ...
                <div class="option-group">
                    ...
                    <div class="usage-steps">
                        <div class="usage-step"><strong>Start a Session:</strong> Enter your key and click "Start Session"</div>
